...
<body>
    ...
    <section>
        <div class="container">
            <div class="user-btn">
                <a href="cab" class='btn-doc  <?php if($_SESSION['user_btn'] == 'doc'){ echo 'active'; }?>'>Документи</a>
                <a href="add_ann" class='btn-ann  <?php if($_SESSION['user_btn'] == 'ann' ){ echo 'active'; }?>'>Додати оголошення</a>
            </div>
